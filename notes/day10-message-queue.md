...
> ⚠️ Session 11 中途暫停，只完成 Chunk 1-4 + Chunk 5 教學（Feynman Gate 未完成）
> 下次繼續：Chunk 5 Gate → Chunk 6 Observability → PoC → Drill → Notes 補完
...
- [ ] Chunk 5 Feynman Gate — 回答小杰「多開 instance」為什麼不能解決重複扣款
- [ ] Chunk 6 Observability Mini（SLIs, SLO, Alerts, Dashboards）
- [ ] Step D: Hands-On PoC
- [ ] Step E: Simon Drill
